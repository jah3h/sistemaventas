            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('unidadmedidas.update',$unidadmedida) }}">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" value="{{$unidadmedida->codigo}}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" value="{{$unidadmedida->nombre}}"
