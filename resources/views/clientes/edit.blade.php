                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('clientes.update',$cliente) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                <input value="{{$cliente->nombres}}" id="nombres" type="text" class="form-control @error('nombres') is-invalid @enderror" name="nombres" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input
                                    value="{{$cliente->email}}"
                                    id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    id="telefono" type="text" class="form-control @error('telefono') is-invalid @enderror" name="telefono" required autofocus>
